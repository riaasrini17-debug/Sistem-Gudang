...
<head>
    ...
    <title>Daftar Barang Owner - Sistem Gudang</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* Menyembunyikan panah default pada tag <details> */
...
<body class="bg-gray-50 text-gray-800 font-sans h-screen overflow-hidden flex">
        ...
        <div class="h-16 flex items-center px-6 border-b border-gray-100">
            ...
            <nav class="flex-1 py-4 space-y-1 overflow-y-auto custom-scrollbar">
                <div class="px-4 space-y-1">
                    ...
                    <a href="{{ route('owner.barang') }}" class="flex items-center gap-3 px-4 py-3 bg-gray-900 text-white rounded-2xl text-sm font-medium shadow-xl">
    ...
    <div class="flex-1 flex flex-col overflow-hidden bg-gray-50">
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Daftar Barang Gudang</h1>
                    ...
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 text-gray-500 font-mono text-xs">SKU-{{ str_pad($item->id, 3, '0', STR_PAD_LEFT) }}</td>
                                ...
                                <td class="px-6 py-4 text-right">
                                    @if($item->stok <= $item->stok_minimum)
                                        <span class="inline-flex items-center gap-1.5 py-1 px-2.5 rounded-md text-xs font-bold bg-red-50 text-red-600 uppercase tracking-wider">
                                            Kritis
                                        </span>
                                    @else
                                        <span class="inline-flex items-center gap-1.5 py-1 px-2.5 rounded-md text-xs font-bold bg-green-50 text-green-600 uppercase tracking-wider">
                                            Aman
                                        </span>
                                    @endif
                                </td>
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center text-gray-400">
                                    ...
                                    <p>Belum ada data barang di gudang.</p>
                                </td>
                            </tr>
                            @endforelse
